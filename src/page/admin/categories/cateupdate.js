...
const cateUpdate = {
    async  print(id){
        ...
        return /* html */`
         ...
         <main>
            ...
            <form class="w-full max-w-4xl m-auto mt-4" method="POST" id="form-update-cate">
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-first-name">
                    Cate name
                </label>
                <input value="${data.cate_name}" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="cate_name" type="text" >
                </div>
    ...
    aftersubmit(cateid){
        const formadd = document.querySelector("#form-update-cate");
