...
const Detail = {
    async  print(id){
        ...
        // const data=data.find((Element) => Element.id==id);
        return /* html */`
        ${await Header.print()}
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div>Trạng thái : ${data.quantity<0 ? "Còn hàng" : "Hết hàng"}</div>
        <div class="flex mb-4">
        ...
        <div class="flex">
        <span class="title-font text-dashed font-medium text-2xl text-gray-900">${data.price - (data.price * data.discount / 100)}</span>
          <span class="title-font ml-10 font-medium text-2xl text-gray-900 line-through ">${data.price.toLocaleString()}</span>
